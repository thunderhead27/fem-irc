...
export default function Card() {
  ...
  const FirstCard = () => {
    ...
    const SelectButton = () => {
      return (
        <div tw="flex flex-row justify-between sm:mb-10">
          {numbers.map(number => (
            <Button
    ...
    return (
      <>
        <div tw="h-10 w-10 rounded-full bg-dBlue flex items-center justify-center mb-4 md:mb-[30px]">
          <Star />
        </div>
        <h1 tw="font-sans text-[28px] text-white font-bold mb-2 md:mb-4">
          How did we do?
        </h1>
        <p tw="text-lGrey text-sm mb-4 md:mb-6">
  ...
  const SecondCard = () => (
    <div tw="flex flex-col items-center">
      <ThankYou tw="mb-6" />
      <div tw="w-[193px] h-8 bg-dBlue rounded-full text-cOrange flex justify-center items-center mb-4 md:mb-8">
